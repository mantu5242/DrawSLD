  ...
  import { updateArrowPort, setArrowLabelVisible, updateArrowLabelOffset } from "../../../Redux/DiagramSlice";

  const PipeArrow = ({ arrow, selected, setEditingLabel }) => {
         ...
         {label?.visible && labelPos && (
          <Text
            ...
            onDragEnd={(e) => {
              ...
              dispatch(updateArrowLabelOffset({
                arrowId: arrow.id,
                offset: {
                  x:
                    (label.offset?.x || 0) +
