...
//     prev.map(a => {
//       const updatePort = (port) => {
//         if (port.attachedTo?.nodeId !== id) return port;
...
//   const onResizeNode = (id, x, y, width, height) => {
//   setNodes(prev =>
//     prev.map(n =>
//       n.id === id
//         ? { ...n, x, y, width, height }
...
//     const commonProps = { node, onDrag: updateNode,onResize:onResizeNode, selected: selected};
//     switch (node.type) {
//       case "PRS":
...
//         <div className="drawsldblock" onClick={addArrow}>Arrow </div>
